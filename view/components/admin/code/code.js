...
function ThemeCodeEditor() {
    ...
    this.editThemeFile =  function(theme, fileName, type, mode) {
        arikaim.page.loadContent({
            id: 'edit_file',
            component: 'editor::admin.code.file.code',
            params: { 
                theme_name: theme,
                file_name: fileName,
                type: type,
    ...
    this.editFile = function(theme, componentName, type) {
        arikaim.page.loadContent({
            id: 'edit_file',
            component: 'editor::admin.code.edit',
            params: { 
                theme_name: theme,
    ...
    this.loadChildComponents = function(theme, parent, id, type) {          
        arikaim.page.loadContent({
            ...
            component: 'editor::admin.code.content.' + type,
            params: { 
                theme_name: theme,
...
var themeCodeEditor = new ThemeCodeEditor();

arikaim.component.onLoaded(function() {
    themeCodeEditor.init();    
});