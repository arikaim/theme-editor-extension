...
{  
    ...
    {       
        ...
        $this->style->writeLn('');
        $this->showTitle('Translate page ');

        $this->style->writeLn('Theme: ' . ConsoleHelper::getLabelText($theme,'green'));
        $this->style->writeLn('Page: ' . ConsoleHelper::getLabelText($pageName,'green'));
        ...
        $translate->translatePage($package,$driver,$language,$pageName);
